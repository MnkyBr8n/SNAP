...
async def list_tools() -> list[Tool]:
    ...
    return [
        ...
        Tool(
            ...
            description="Query a specific snapshot by type and file. Both snapshot_type and file_path are required.",
            inputSchema={
                "type": "object",
                "properties": {
                    "project_id": {
                    ...
                    "snapshot_type": {
                        ...
                        "enum": [
                            ...
                            "classes", "connections", "metadata", "security",
                            "quality", "doc_metadata", "doc_content", "analysis",
                            "config_metadata", "classes_detail", "functions_core",
                            "doc_synthesis", "csv_schema", "csv_data", "config_api"
                ...
                "required": ["project_id", "snapshot_type", "file_path"],
            },
        ),
        Tool(
            name="list_projects",
